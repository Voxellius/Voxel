...
const PASSES_TO_CHECK = [
    ...
    stringCheck("PASS ternary alwaysTruthy"),
    stringCheck("PASS ternary alwaysFalsy"),
    stringCheck("PASS ternary alwaysUnknown ifTrue"),
    stringCheck("PASS ternary alwaysUnknown"),
    stringCheck("PASS ternary alwaysTruthy"),
